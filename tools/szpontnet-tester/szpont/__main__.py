"""CLI entry point for the SzpontNet conformance tester.
    ...
    # a subset, verbosely (categories A–K; I/J/K = chapter-11 trust + server/API-key + auth gossip):
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--only", help="comma-separated categories to run (A-K); default all")
