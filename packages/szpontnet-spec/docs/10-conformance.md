...
[`test_mesh_logic.py`](../../diplomat-platform/linux/tests/test_mesh_logic.py) (pure) and
[`test_mesh_node.py`](../../diplomat-platform/linux/tests/test_mesh_node.py) (real sockets).
