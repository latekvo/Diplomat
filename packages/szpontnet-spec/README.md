...
The normative definition of **SzpontNet** (v0.4.0, wire `v: 1`), the leaderless
...
| | |
|---|---|
| [`docs/`](docs/README.md) | the **normative specification**: 15 chapters ordered for bottom-up implementation, from the model and discovery through dispatch, trust, work-claims and the Tor transport |
