...
Deliberately empty of side effects and of imports. Installing the host is the
importer's call (``diplomat_app/__init__`` makes it), and this file is on the import
path of the stdlib-only node daemon, which must not pay for a module it never uses.
"""
