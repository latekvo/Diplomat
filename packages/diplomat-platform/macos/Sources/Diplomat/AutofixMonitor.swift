...
// just the GitHub read. The queries themselves live in `assets/graphql/` with the other
...
enum AutofixMonitor {
    ...
    /// call, `assets/graphql/review-requests`). `includeFiles` pulls each PR's changed
