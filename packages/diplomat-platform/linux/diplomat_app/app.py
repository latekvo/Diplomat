...
def auto_refresh_secs() -> float:
    raw = os.environ.get("DIPLOMAT_REFRESH_SECS")
    try:
...
def autofix_poll_secs() -> float:
    ...
    Overridable with DIPLOMAT_AUTOFIX_SECS; floored at 30s to protect the
    shared GitHub rate-limit budget."""
    raw = os.environ.get("DIPLOMAT_AUTOFIX_SECS")
    try:
...
def apiwatch_poll_secs() -> float:
    ...
    raw = os.environ.get("DIPLOMAT_APIWATCH_SECS")
    try:
...
class DiplomatApp:
    def __init__(self) -> None:
        ...
        self.app.setApplicationName("Diplomat")
        self.app.setOrganizationName("diplomat")
    ...
    def confirm_quit(self) -> None:
        ...
        box.setWindowTitle("Quit Diplomat?")
        box.setText("Quit Diplomat?")
