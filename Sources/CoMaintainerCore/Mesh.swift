...
/// Shared, platform-neutral model for **Co-Maintainer Mesh** — the LAN P2P duty-coordination
...
/// as the Python front-end's `co_maintainer.mesh.config` / `.statefile` do.
///
...
/// Mirrors the shape documented in `co_maintainer.mesh.statefile`.
