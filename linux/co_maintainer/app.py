...
def auto_refresh_secs() -> float:
    raw = os.environ.get("CO_MAINTAINER_REFRESH_SECS")
    try:
...
def autofix_poll_secs() -> float:
    ...
    Overridable with CO_MAINTAINER_AUTOFIX_SECS; floored at 30s to protect the
    shared GitHub rate-limit budget."""
    raw = os.environ.get("CO_MAINTAINER_AUTOFIX_SECS")
    try:
...
class CoMaintainerApp:
    def __init__(self) -> None:
        self.app = QApplication.instance() or QApplication(sys.argv)
        self.app.setQuitOnLastWindowClosed(False)
        self.app.setApplicationName("Co-Maintainer")
        self.app.setOrganizationName("co-maintainer")
        ...
        prefill = os.environ.get("CO_MAINTAINER_PREFILL")
        if prefill:
    ...
    def _build_tray(self) -> None:
        ...
        self.tray.setToolTip("Co-Maintainer")
        menu = QMenu()
    ...
    def confirm_quit(self) -> None:
        ...
        box.setWindowTitle("Quit Co-Maintainer?")
        box.setText("Quit Co-Maintainer?")
