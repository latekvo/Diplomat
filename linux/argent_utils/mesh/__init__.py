"""Argent Mesh — LAN P2P coordination between the machines running Argent Utils.
...
- standalone/headless on any machine with Python 3.10+::
      ...
      python -m argent_utils.mesh              # foreground node
      python -m argent_utils.mesh --daemon     # detach
      python -m argent_utils.mesh --status     # print the live topology
      python -m argent_utils.mesh --set tokens=out tier=2
      python -m argent_utils.mesh --dispatch review --prompt "…"
